 ...
 */
class ScriptTask(var databaseConnector: DatabaseConnector, override var taskName: String, override var taskOrder: Int, val script: String, delimiter: String?): Task {
