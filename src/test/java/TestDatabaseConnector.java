...
public class TestDatabaseConnector {
    ...
    @Test
    public void testExecuteChange() throws SQLException {
        Change change = new Change("1", "SELECT * FROM Table");
        Mockito.when(preparedStatement.executeQuery()).thenReturn(getEmptySet());
        Assert.assertTrue(databaseConnector.executeChange(change));
        Mockito.verify(statement).execute("SELECT * FROM Table");
    ...
    public void testExecuteChanges() throws SQLException {
        ...
        changes.add(new Change("1", "SELECT * FROM Table1"));
        changes.add(new Change("1", "SELECT * FROM Table2; SELECT * FROM Table3"));
        Mockito.when(preparedStatement.executeQuery()).thenReturn(getEmptySet());
        Assert.assertTrue(databaseConnector.executeChanges(changes));
        Mockito.verify(statement).execute("SELECT * FROM Table1");
        Mockito.verify(statement).execute("SELECT * FROM Table2");
